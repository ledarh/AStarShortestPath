...
public class Prog340 extends JPanel /*implements ActionListener*/ {
	...
	File inputFile; // distance
	File inputFile2; // heuristic
	File outputFile;
	PrintWriter output;
	...
	JMenuItem readFile, readFile2, exit;
...
**/
  public Prog340() {
	...
	readFile = new JMenuItem("Read Distance File");
	mainMenu.add(readFile);
    readFile2 = new JMenuItem("Read Heuristic File");
    mainMenu.add(readFile2);
	...
	readFile2.addActionListener( new ActionListener() {
		public void actionPerformed( ActionEvent e ) {
			...
			if (fileChooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
				...
				// Instantiate the selected input and output files.
				inputFile2 = fileChooser.getSelectedFile();
				System.out.println( "Chosen file = " + inputFile2 + "\n");
			}

			g2 = new Graph();
			readGraphInfo(inputFile2, g2);
		}
	});
...
**/
  public void readGraphInfo(File inputFile, Graph g) {
	try {
		// read text file
